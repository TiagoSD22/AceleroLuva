...
void AcceleroMMA7361::getAccelXYZ(int *_XAxis, int *_YAxis, int *_ZAxis)
{
  ...
  *_XAxis = sum[0] / average;
  *_YAxis = sum[1] / average;
  *_ZAxis = sum[2] / average;
}
